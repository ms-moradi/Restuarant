        ...
        <div className="w-[220px] inline-block shadow-3xl p-6">
            <div className=" flex flex-col items-center gap-6 pb-6">
                <div className="rounded-full overflow-hidden">
                    <Image src={team1} alt="team" className="hover:scale-125"/>
                </div>
                <div className="flex flex-col items-center">
                    <h5 className={`${nunito.className} text-xl font-extrabold`}>Full Name</h5>
                    <p className={`${heebo.className} text-[#666565] text-sm font-normal`}>Designation</p>
                </div>
            </div>
            <div>
