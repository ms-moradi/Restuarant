...
const Service =()=>{
    return(
        <div className='flex justify-center content-center gap-[25px] my-3 px-[60px]'>
            {data.map((card) => (
                <div key={card.id} className="inline-block w-[240px] h-[240px] border hover:bg-[#fea116] hover:text-[#fff] p-6 drop-shadow-xl ">
